...
## Outlier Detection: Check Trials Function

Reaction Time per Trial {.tabset}

```{r}
#| label: outliers_RTtrials
#| message: false
#| warning: false
...
# Outlier Detection: Illusion & Perceptual Tasks

## Illusion Task: Session 1

```{r}
#| label: p_outliers_RTtrials_session1
#| message: false
#| warning: false
#| results: asis
...
```{r}
#| label: p_outliers_RTtrials_session2
#| message: false
#| warning: false
#| results: asis
...
```{r}
#| label: p_outliers_RTtrials_perceptual
#| message: false
#| warning: false
#| results: asis
...
```{r}
#| label: p_demographics_ethnicity
#| message: false
#| warning: false
#| dpi: 200
...
```{r}
#| label: p_demographics_education
#| message: false
#| warning: false
#| dpi: 200
p_edu <- sub |>
